    ...
    ko: {
      translation: {
        ...
        project4: {
          ...
          description: "주문 과정에서 이탈률을 줄이고 주문 완료율을 높이기 위해 기존 퍼널을 개선하여 A/B Test를 진행하였고 기존 주문 완료율 57.97%에서 62%로 약 4~5% 정도 개선된 성과를 얻었습니다. 프로젝트를 진향하면서 신규 입사자로 이루어진 스쿼드에서 개발적인 의사소통, 일정 산정과 관련하여 어려움이 있을 때, 자발적으로 중간에서 조력자 역할을 도맡아 일정을 조율하거나 내용을 정리해 소통의 어려움을 해소하였습니다. 이때 보여준 모습으로 동료들 에게 신뢰를 얻어 이달의 우수사원으로 선정되었습니다."
        },
        project5: {
